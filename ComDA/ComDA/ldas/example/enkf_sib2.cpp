...
//To do: read the real-world measurements with different scales to assign xtrue and xobs
/*
...
//To do: calculate the simulation of Sib2
/*
    x0[0]=-5.9;
    x0[1]=-5.0;
    x0[2]=24.0;
...
//To do: assimilation obs and Sib2 with EnKF
